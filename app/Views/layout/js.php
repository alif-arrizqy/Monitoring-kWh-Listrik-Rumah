...
<script src="<?= base_url('public/assets/js/init/ampwatt-chart.js') ?>"></script>
<script src="<?= base_url('public/assets/js/init/chart_arus.js') ?>"></script>
...
<!-- Alert -->
<script src="<?= base_url('public/assets/dist/sweetalert2.all.min.js')?>"></script>
<script src="<?= base_url('public/assets/alert.js')?>"></script>
