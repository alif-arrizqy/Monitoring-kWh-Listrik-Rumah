...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-exclamation-triangle"></i><a href="arus.html">Arus</a></li>
                            <li><i class="fa fa-bolt"></i><a href="tegangan.html">Tegangan</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">Arus</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">Tegangan</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        <canvas id="lineChartTegangan"></canvas>
                                    </div>
                                </div>
                            </div> <!-- /.row -->
                        </div>
    ...
    <script src="assets/js/init/chart_tegangan.js"></script>
